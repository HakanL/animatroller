...
namespace Animatroller.Scenes
{
    internal partial class Halloween2016 : BaseScene
    {
        ...
        Expander.MonoExpanderInstance expanderAudio2 = new Expander.MonoExpanderInstance(hardware: Expander.MonoExpanderInstance.HardwareType.PiFace);
        ...
        Expander.MonoExpanderInstance expanderPop = new Expander.MonoExpanderInstance(hardware: Expander.MonoExpanderInstance.HardwareType.PiFace);
